...
/**
 * <p>Java class for drm-typeType complex type.
 * 
...
@XmlType(name = "drm-typeType", namespace = "http://localhost:8080/decoupling/schemas/common", propOrder = {
    "code",
    "name",
    "isDrm",
    "isJdp"
})
public class DrmTypeType
