 ...
 *         &lt;element name="sp-type" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "modify-sp-type", namespace = "")
public class ModifySpType
    implements Serializable, Element
{
    ...
    @XmlElement(name = "sp-type", required = true)
