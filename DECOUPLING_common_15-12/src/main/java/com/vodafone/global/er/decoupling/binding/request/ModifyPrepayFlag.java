 ...
 *         &lt;element name="is-prepay" type="{http://localhost:8080/decoupling/schemas/common}isPrepay"/>
...
@XmlRootElement(name = "modify-prepay-flag", namespace = "")
public class ModifyPrepayFlag
    implements Serializable, Element
{
    ...
    @XmlElement(name = "is-prepay", required = true)
