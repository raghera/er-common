 ...
 *         &lt;element name="new-msisdn" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "modify-msisdn", namespace = "")
public class ModifyMsisdn
    implements Serializable, Element
{
    ...
    @XmlElement(name = "new-msisdn", required = true)
