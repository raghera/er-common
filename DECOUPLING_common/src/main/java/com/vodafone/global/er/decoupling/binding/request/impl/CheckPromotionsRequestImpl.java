...
public class CheckPromotionsRequestImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.CheckPromotionsRequestTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.CheckPromotionsRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.CheckPromotionsRequest.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "check-promotions-request";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.CheckPromotionsRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "check-promotions-request");
...
+"$ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0013p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0011sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00001q"
+"\u0000~\u00005sq\u0000~\u0000/t\u0000\u0006log-idq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00001q"
+"\u0000~\u00005sq\u0000~\u0000/t\u0000\u0018check-promotions-requestq\u0000~\u00009sr\u0000\"com.sun.msv.gr"
...
+"\u0000~\u0000\rq\u0000~\u0000;q\u0000~\u0000Bq\u0000~\u0000\nq\u0000~\u0000%q\u0000~\u0000<q\u0000~\u0000Cq\u0000~\u0000Gq\u0000~\u0000\u000bq\u0000~\u0000\tx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.CheckPromotionsRequestImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("msisdn" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.CheckPromotionsRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.CheckPromotionsRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("check-promotions-request" == ___local)&&("" == ___uri)) {
