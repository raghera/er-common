...
public class GetReasonCodesResponseTypeImpl implements com.vodafone.global.er.decoupling.binding.response.GetReasonCodesResponseType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _ReasonCode;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.GetReasonCodesResponseType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getReasonCode() {
        if (_ReasonCode == null) {
            _ReasonCode = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _ReasonCode;
    }

    public java.util.List getReasonCode() {
        return _getReasonCode();
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.GetReasonCodesResponseTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_ReasonCode == null)? 0 :_ReasonCode.size());
        while (idx1 != len1) {
            context.startElement("", "reason-code");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ReasonCode.get(idx_0 ++)), "ReasonCode");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ReasonCode.get(idx_1 ++)), "ReasonCode");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _ReasonCode.get(idx1 ++)), "ReasonCode");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000Acom.vodafone.global.er.decoupling.binding.response.Reas"
+"onCodeTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~"
...
+"g/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000breason-codet\u0000\u0000q\u0000~\u0000\u001dsr"
...
+"l;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.GetReasonCodesResponseTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("code" == ___local)&&("" == ___uri)) {
                            _getReasonCode().add(((com.vodafone.global.er.decoupling.binding.response.impl.ReasonCodeTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.ReasonCodeTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
