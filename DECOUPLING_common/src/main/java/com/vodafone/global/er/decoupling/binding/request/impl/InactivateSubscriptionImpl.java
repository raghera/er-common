...
public class InactivateSubscriptionImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.InactivateSubscriptionTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.InactivateSubscription, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.InactivateSubscription.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "inactivate-subscription";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.InactivateSubscriptionImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "inactivate-subscription");
...
+"~\u00009sq\u0000~\u00003t\u0000\u000fsubscription-idq\u0000~\u0000=sq\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0017p\u0000sq\u0000~\u0000\u0007p"
+"pq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0006csr-idq\u0000~\u0000"
+"=q\u0000~\u00009sq\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0017p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017p"
+"q\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0006reasonq\u0000~\u0000=q\u0000~\u00009sq\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0017p"
+"\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0006lo"
+"g-idq\u0000~\u0000=q\u0000~\u00009sq\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0017p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0012ppsr\u0000$com.s"
+"un.msv.datatype.xsd.BooleanType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0019q\u0000~\u0000\u001ft\u0000\u0007bool"
+"eanq\u0000~\u00001q\u0000~\u0000%sq\u0000~\u0000&q\u0000~\u0000_q\u0000~\u0000\u001fsq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q"
+"\u0000~\u00009sq\u0000~\u00003t\u0000\u0014apply-penalty-chargeq\u0000~\u0000=q\u0000~\u00009sq\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~"
+"\u0000\u0017p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\\sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000"
+"\u0016override-disallow-flagq\u0000~\u0000=q\u0000~\u00009sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000"
+"~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0017inactivate-subscriptionq\u0000~\u0000=sr\u0000\"com.sun.msv"
...
+"\u0000\fq\u0000~\u0000\tq\u0000~\u0000Dq\u0000~\u0000Kq\u0000~\u0000Rq\u0000~\u0000\u0011q\u0000~\u0000?q\u0000~\u0000Fq\u0000~\u0000Mq\u0000~\u0000Tq\u0000~\u0000\u000eq\u0000~\u0000\u000bq\u0000~"
+"\u0000)q\u0000~\u0000@q\u0000~\u0000Gq\u0000~\u0000Nq\u0000~\u0000Uq\u0000~\u0000aq\u0000~\u0000hq\u0000~\u0000lq\u0000~\u0000[q\u0000~\u0000gq\u0000~\u0000\u000fq\u0000~\u0000\rq\u0000~"
+"\u0000Yq\u0000~\u0000eq\u0000~\u0000\nx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.InactivateSubscriptionImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("msisdn" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.InactivateSubscriptionTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.InactivateSubscriptionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("inactivate-subscription" == ___local)&&("" == ___uri)) {
