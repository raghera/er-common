...
public class InactivateAccountTypeImpl implements com.vodafone.global.er.decoupling.binding.request.InactivateAccountType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.InactivateAccountType.class);
    }
    ...
    public java.lang.String getValidateAccount() {
        return _ValidateAccount;
    }

    public void setValidateAccount(java.lang.String value) {
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.InactivateAccountTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_ValidateAccount!= null) {
            context.startElement("", "validate-account");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _ValidateAccount), "ValidateAccount");
            } catch (java.lang.Exception e) {
                com.vodafone.global.er.decoupling.binding.request.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"ppq\u0000~\u0000\u0011sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0010validate-"
+"accountq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000$ppsq\u0000~\u0000\tq\u0000~\u0000\u0013p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0011sq\u0000~\u0000$pps"
+"q\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0006csr-idq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000$pps"
+"q\u0000~\u0000\tq\u0000~\u0000\u0013p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0011sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005"
+"sq\u0000~\u0000/t\u0000\u0006reasonq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000$ppsq\u0000~\u0000\tq\u0000~\u0000\u0013p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0011s"
+"q\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0006log-idq\u0000~\u00009q\u0000~\u00005s"
...
+"ol;xp\u0000\u0000\u0000\u0012\u0001pq\u0000~\u0000\u0005q\u0000~\u0000:q\u0000~\u0000Aq\u0000~\u0000Hq\u0000~\u0000Oq\u0000~\u0000\rq\u0000~\u0000<q\u0000~\u0000Cq\u0000~\u0000Jq\u0000~\u0000"
+"Qq\u0000~\u0000%q\u0000~\u0000=q\u0000~\u0000Dq\u0000~\u0000Kq\u0000~\u0000Rq\u0000~\u0000\u0006q\u0000~\u0000\u0007q\u0000~\u0000\bx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.InactivateAccountTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  9 :
                        ...
                        continue outer;
                    case  3 :
                        if (("validate-account" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 4;
                            return ;
                        }
