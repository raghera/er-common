...
public class IsUniquePromoPrecodeResponseTypeImpl implements com.vodafone.global.er.decoupling.binding.response.IsUniquePromoPrecodeResponseType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected boolean has_IsUniquePromoPrecode;
    protected boolean _IsUniquePromoPrecode;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.IsUniquePromoPrecodeResponseType.class);
    }

    public boolean isIsUniquePromoPrecode() {
        return _IsUniquePromoPrecode;
    }

    public void setIsUniquePromoPrecode(boolean value) {
        _IsUniquePromoPrecode = value;
        has_IsUniquePromoPrecode = true;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.IsUniquePromoPrecodeResponseTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (!has_IsUniquePromoPrecode) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "IsUniquePromoPrecode"));
        }
        context.startElement("", "is-unique-promo-precode");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _IsUniquePromoPrecode)), "IsUniquePromoPrecode");
...
+"\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\u001c\u0001psq\u0000~\u0000)t\u0000\u0017is-unique-promo-precodet\u0000\u0000sr\u0000\"com.su"
...
+"\u0001pq\u0000~\u0000!q\u0000~\u0000\tx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.IsUniquePromoPrecodeResponseTypeImpl.this;
        }
        ...
        {
            try {
                _IsUniquePromoPrecode = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_IsUniquePromoPrecode = true;
            } catch (java.lang.Exception e) {
