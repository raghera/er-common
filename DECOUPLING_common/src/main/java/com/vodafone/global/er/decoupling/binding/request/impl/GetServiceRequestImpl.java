...
public class GetServiceRequestImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.GetServiceRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.GetServiceRequest.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "get-service-request");
...
+"\u0000/t\u0000\u0013get-service-requestq\u0000~\u00009sr\u0000\"com.sun.msv.grammar.Express"
...
+"<q\u0000~\u0000%q\u0000~\u0000=q\u0000~\u0000Aq\u0000~\u0000\nq\u0000~\u0000\tx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("get-service-request" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("service-id" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetServiceRequestImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
