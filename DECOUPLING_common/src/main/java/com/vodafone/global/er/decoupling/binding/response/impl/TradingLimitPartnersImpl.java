...
public class TradingLimitPartnersImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.TradingLimitPartners, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.TradingLimitPartners.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "trading-limit-partners");
...
+"~\u0000\u000f\u0001psq\u0000~\u00001t\u0000\npartner-idt\u0000\u0000q\u0000~\u00007sq\u0000~\u0000\nppsq\u0000~\u0000(q\u0000~\u0000\u0010pq\u0000~\u0000*q\u0000~"
+"\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0016trading-limit-partnersq\u0000~\u0000;sr\u0000\"com.sun.msv.g"
...
+"q\u0000~\u0000\u000bq\u0000~\u0000\'q\u0000~\u0000<q\u0000~\u0000\tq\u0000~\u0000\u000ex"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("partner-id" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
                        if (("trading-limit-partners" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.TradingLimitPartnersImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
