...
/**
 * <p>Java class for basicPackageType complex type.
 * 
...
@XmlType(name = "basicPackageType", namespace = "http://localhost:8080/decoupling/schemas/common", propOrder = {
    "packageId",
    "packageName",
    "status"
})
public class BasicPackageType
