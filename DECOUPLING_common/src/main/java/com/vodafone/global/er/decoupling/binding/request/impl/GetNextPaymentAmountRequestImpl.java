...
public class GetNextPaymentAmountRequestImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.GetNextPaymentAmountRequestTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.GetNextPaymentAmountRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.GetNextPaymentAmountRequest.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "get-next-payment-amount-request";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.GetNextPaymentAmountRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "get-next-payment-amount-request");
...
+"\u0000$ppsq\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u000fsubscription-idq\u0000~\u00009"
+"sq\u0000~\u0000$ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0013p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0011sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q"
+"\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0006log-idq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000\u0013pq\u0000~\u0000(q"
+"\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u001fget-next-payment-amount-requestq\u0000~\u00009sr\u0000\"co"
...
+"\tx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.GetNextPaymentAmountRequestImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("msisdn" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.GetNextPaymentAmountRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetNextPaymentAmountRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  0 :
                        if (("get-next-payment-amount-request" == ___local)&&("" == ___uri)) {
