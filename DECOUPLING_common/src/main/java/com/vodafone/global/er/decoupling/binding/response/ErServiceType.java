...
/**
 * <p>Java class for erServiceType complex type.
 * 
...
@XmlType(name = "erServiceType", namespace = "http://localhost:8080/decoupling/schemas/common", propOrder = {
    "id",
    "name",
    "description",
    "pricingText1",
    ...
    implements Serializable, Element
{
    ...
    protected ErServiceType.PricePoints pricePoints;
     ...
     * @return
     *     possible object is
     *     {@link ErServiceType.PricePoints }
     *     
     */
    public ErServiceType.PricePoints getPricePoints() {
        return pricePoints;
    }
     ...
     *     
     */
    public void setPricePoints(ErServiceType.PricePoints value) {
