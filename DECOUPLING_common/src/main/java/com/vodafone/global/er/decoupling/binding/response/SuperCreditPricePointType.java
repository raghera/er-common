...
/**
 * <p>Java class for super-credit-price-pointType complex type.
 * 
...
@XmlType(name = "super-credit-price-pointType", namespace = "http://localhost:8080/decoupling/schemas/common", propOrder = {
    "rateIdentifier",
    "superCreditText",
    "isActive",
    "id",
...
public class SuperCreditPricePointType
