...
public class ModifySubscriptionAuthorizationImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionAuthorizationTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.ModifySubscriptionAuthorization, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.ModifySubscriptionAuthorization.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "modify-subscription-authorization";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionAuthorizationImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "modify-subscription-authorization");
...
+"mmar.Expression$AnyStringExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004q\u0000~\u00003psr"
...
+"\u0000#ppsq\u0000~\u0000%q\u0000~\u0000 pq\u0000~\u0000\'q\u0000~\u0000.q\u0000~\u00002sq\u0000~\u0000,t\u0000!modify-subscription-"
+"authorizationq\u0000~\u00006sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000"
...
+"q\u0000~\u0000Jq\u0000~\u0000=q\u0000~\u0000\fx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionAuthorizationImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("is-success" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionAuthorizationTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionAuthorizationImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  0 :
                        if (("modify-subscription-authorization" == ___local)&&("" == ___uri)) {
