...
/**
 * Created the CustomXmlStreamReader to get rid of following exception
 * <blockquote>java.lang.IllegalArgumentException: Unrecognized property 'javax.xml.stream.isInterning'</blockquote><br/>
 * It's a thin wrapper of a XMLStreamReader.
 * @author sharmao
 *
 */
public class CustomXmlStreamReader implements XMLStreamReader {

	private XMLStreamReader delegate;

	public CustomXmlStreamReader(XMLStreamReader delegate) {
		this.delegate = delegate;
	}

	@Override
	public Object getProperty(String name) throws IllegalArgumentException {
		if ("javax.xml.stream.isInterning".equals(name))
	...
	public int getTextCharacters(int sourceStart, char[] target,
		...
		return delegate.getTextCharacters(sourceStart, target, targetStart,
				length);
	}
