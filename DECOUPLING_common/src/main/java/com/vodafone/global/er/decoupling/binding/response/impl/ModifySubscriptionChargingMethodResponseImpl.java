...
public class ModifySubscriptionChargingMethodResponseImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionChargingMethodResponseTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.ModifySubscriptionChargingMethodResponse, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.ModifySubscriptionChargingMethodResponse.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "modify-subscription-charging-method-response";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionChargingMethodResponseImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "modify-subscription-charging-method-response");
...
+"L\u0000\tnameClassq\u0000~\u0000\u0001xq\u0000~\u0000\u0004q\u0000~\u0000\u001fpsq\u0000~\u0000\fppsr\u0000\"com.sun.msv.datatyp"
...
+"ression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\u001e\u0001psq\u0000~\u0000+t\u0000\u0007successt\u0000\u0000sq\u0000~\u0000\"pps"
+"q\u0000~\u0000$q\u0000~\u0000\u001fpq\u0000~\u0000&q\u0000~\u0000-q\u0000~\u00001sq\u0000~\u0000+t\u0000,modify-subscription-charg"
+"ing-method-responseq\u0000~\u00005sr\u0000\"com.sun.msv.grammar.ExpressionPo"
...
+"/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000#q\u0000~\u00006q\u0000~\u0000\tq\u0000~\u0000\u000bx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionChargingMethodResponseImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("success" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionChargingMethodResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.ModifySubscriptionChargingMethodResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  0 :
                        if (("modify-subscription-charging-method-response" == ___local)&&("" == ___uri)) {
