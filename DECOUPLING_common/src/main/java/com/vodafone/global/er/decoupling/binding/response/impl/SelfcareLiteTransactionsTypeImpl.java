...
public class SelfcareLiteTransactionsTypeImpl implements com.vodafone.global.er.decoupling.binding.response.SelfcareLiteTransactionsType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _LiteTransaction;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.SelfcareLiteTransactionsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getLiteTransaction() {
        if (_LiteTransaction == null) {
            _LiteTransaction = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _LiteTransaction;
    }

    public java.util.List getLiteTransaction() {
        return _getLiteTransaction();
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_LiteTransaction == null)? 0 :_LiteTransaction.size());
        while (idx1 != len1) {
            context.startElement("", "lite-transaction");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _LiteTransaction.get(idx_0 ++)), "LiteTransaction");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _LiteTransaction.get(idx_1 ++)), "LiteTransaction");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _LiteTransaction.get(idx1 ++)), "LiteTransaction");
            context.endElement();
        }
    }
...
+"sactionLiteTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-element"
...
+"w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0010lite-transaction"
...
+"ressionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _getLiteTransaction().add(((com.vodafone.global.er.decoupling.binding.response.impl.TransactionLiteTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.TransactionLiteTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
