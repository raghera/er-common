 ...
 *         &lt;element name="timezone" type="{http://localhost:8080/decoupling/schemas/common}utcTimezoneOffset"/>
...
@XmlRootElement(name = "modify-timezone", namespace = "")
public class ModifyTimezone
