...
public class SelfcareLiteTransactionsRequestTypeImpl implements com.vodafone.global.er.decoupling.binding.request.SelfcareLiteTransactionsRequestType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{

    protected java.lang.String _PartnerId;
    protected boolean has_AdditionalAttributesRequired;
    protected boolean _AdditionalAttributesRequired;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.SelfcareLiteTransactionsRequestType.class);
    }
    ...
    public boolean isAdditionalAttributesRequired() {
        return _AdditionalAttributesRequired;
    }

    public void setAdditionalAttributesRequired(boolean value) {
        _AdditionalAttributesRequired = value;
        has_AdditionalAttributesRequired = true;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.SelfcareLiteTransactionsRequestTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (has_AdditionalAttributesRequired) {
            context.startElement("", "additional-attributes-required");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _AdditionalAttributesRequired)), "AdditionalAttributesRequired");
            } catch (java.lang.Exception e) {
                com.vodafone.global.er.decoupling.binding.request.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"%q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00000q\u0000~\u00004sq\u0000~\u0000.t\u0000\npartner-idq\u0000~\u00008sq\u0000~\u0000#ppsq\u0000~\u0000\b"
+"q\u0000~\u0000\u0012p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0010sq\u0000~\u0000#ppsq\u0000~\u0000%q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00000q\u0000~\u00004sq\u0000~\u0000"
+".t\u0000\u0006log-idq\u0000~\u00008q\u0000~\u00004sq\u0000~\u0000#ppsq\u0000~\u0000\bq\u0000~\u0000\u0012p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\rppsr\u0000"
+"$com.sun.msv.datatype.xsd.BooleanType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0014q\u0000~\u0000\u001at"
+"\u0000\u0007booleanq\u0000~\u0000,q\u0000~\u0000 sq\u0000~\u0000!q\u0000~\u0000Lq\u0000~\u0000\u001asq\u0000~\u0000#ppsq\u0000~\u0000%q\u0000~\u0000\u0012pq\u0000~\u0000\'"
+"q\u0000~\u00000q\u0000~\u00004sq\u0000~\u0000.t\u0000\u001eadditional-attributes-requiredq\u0000~\u00008q\u0000~\u00004s"
...
+"ol;xp\u0000\u0000\u0000\r\u0001pq\u0000~\u0000?q\u0000~\u0000\fq\u0000~\u0000:q\u0000~\u0000Aq\u0000~\u0000\u0006q\u0000~\u0000$q\u0000~\u0000;q\u0000~\u0000Bq\u0000~\u0000Nq\u0000~\u0000"
+"Hq\u0000~\u0000\u0005q\u0000~\u0000\u0007q\u0000~\u0000Fx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.SelfcareLiteTransactionsRequestTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  9 :
                        if (("additional-attributes-required" == ___local)&&("" == ___uri)) {
        ...
        {
            try {
                _AdditionalAttributesRequired = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_AdditionalAttributesRequired = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
