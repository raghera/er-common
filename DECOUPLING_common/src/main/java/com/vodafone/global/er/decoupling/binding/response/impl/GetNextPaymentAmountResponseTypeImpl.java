...
public class GetNextPaymentAmountResponseTypeImpl implements com.vodafone.global.er.decoupling.binding.response.GetNextPaymentAmountResponseType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.vodafone.global.er.decoupling.binding.response.NextPaymentAmountType _NextPaymentAmount;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.GetNextPaymentAmountResponseType.class);
    }

    public com.vodafone.global.er.decoupling.binding.response.NextPaymentAmountType getNextPaymentAmount() {
        return _NextPaymentAmount;
    }

    public void setNextPaymentAmount(com.vodafone.global.er.decoupling.binding.response.NextPaymentAmountType value) {
        _NextPaymentAmount = value;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.GetNextPaymentAmountResponseTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (_NextPaymentAmount!= null) {
            context.startElement("", "next-payment-amount");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _NextPaymentAmount), "NextPaymentAmount");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _NextPaymentAmount), "NextPaymentAmount");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _NextPaymentAmount), "NextPaymentAmount");
            context.endElement();
        }
    }
...
+"amet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000Hcom.vod"
+"afone.global.er.decoupling.binding.response.NextPaymentAmoun"
...
+"1/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0013next-payment-amountt\u0000\u0000q\u0000~\u0000"
...
+"Pool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000\u000fq\u0000~\u0000\"q\u0000~\u0000\u0012x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.GetNextPaymentAmountResponseTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("rate" == ___local)&&("" == ___uri)) {
                            _NextPaymentAmount = ((com.vodafone.global.er.decoupling.binding.response.impl.NextPaymentAmountTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.NextPaymentAmountTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  3 :
