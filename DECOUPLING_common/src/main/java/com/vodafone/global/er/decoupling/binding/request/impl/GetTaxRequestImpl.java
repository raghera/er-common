    ...
    implements com.vodafone.global.er.decoupling.binding.request.GetTaxRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.GetTaxRequest.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "get-tax-request");
...
+"\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\u000e\u0001psq\u0000~\u0000/t\u0000\u0004namet\u0000\u0000q\u0000~\u00005sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0000q\u0000~\u0000\u000f"
+"p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0014sq\u0000~\u0000\u000bppsq\u0000~\u0000&q\u0000~\u0000\u000fpq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0006l"
+"og-idq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000\u000bppsq\u0000~\u0000&q\u0000~\u0000\u000fpq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u000fg"
+"et-tax-requestq\u0000~\u00009sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000"
...
+"grammar/ExpressionPool;xp\u0000\u0000\u0000\t\u0001pq\u0000~\u0000\fq\u0000~\u0000:q\u0000~\u0000\u0010q\u0000~\u0000<q\u0000~\u0000%q\u0000~\u0000"
+"=q\u0000~\u0000Aq\u0000~\u0000\nq\u0000~\u0000\tx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("get-tax-request" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetTaxRequestImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
