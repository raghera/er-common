...
public class SelfcareFullBalancesTypeImpl implements com.vodafone.global.er.decoupling.binding.response.SelfcareFullBalancesType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Balance;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.SelfcareFullBalancesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getBalance() {
        if (_Balance == null) {
            _Balance = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Balance;
    }

    public java.util.List getBalance() {
        return _getBalance();
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.SelfcareFullBalancesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Balance == null)? 0 :_Balance.size());
        while (idx1 != len1) {
            context.startElement("", "balance");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Balance.get(idx_0 ++)), "Balance");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Balance.get(idx_1 ++)), "Balance");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Balance.get(idx1 ++)), "Balance");
            context.endElement();
        }
    }
...
+"www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0007balancet\u0000\u0000q\u0000"
...
+"onPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.SelfcareFullBalancesTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("subscription-id" == ___local)&&("" == ___uri)) {
                            _getBalance().add(((com.vodafone.global.er.decoupling.binding.response.impl.ResourceBalanceFullTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.ResourceBalanceFullTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
