...
public class GetBasePricesResponseTypeImpl implements com.vodafone.global.er.decoupling.binding.response.GetBasePricesResponseType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _BasePrices;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.GetBasePricesResponseType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getBasePrices() {
        if (_BasePrices == null) {
            _BasePrices = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _BasePrices;
    }

    public java.util.List getBasePrices() {
        return _getBasePrices();
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.GetBasePricesResponseTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_BasePrices == null)? 0 :_BasePrices.size());
        while (idx1 != len1) {
            context.startElement("", "base-prices");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _BasePrices.get(idx_0 ++)), "BasePrices");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _BasePrices.get(idx_1 ++)), "BasePrices");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _BasePrices.get(idx1 ++)), "BasePrices");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000<com.vodafone.global.er.decoupling.binding.response.Base"
+"Pricet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000pps"
...
+"1/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000bbase-pricest\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com"
...
+"\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.GetBasePricesResponseTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("service-id" == ___local)&&("" == ___uri)) {
                            _getBasePrices().add(((com.vodafone.global.er.decoupling.binding.response.impl.BasePriceImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.BasePriceImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
