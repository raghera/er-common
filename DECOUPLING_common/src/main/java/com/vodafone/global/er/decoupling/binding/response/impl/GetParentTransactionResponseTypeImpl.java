...
public class GetParentTransactionResponseTypeImpl implements com.vodafone.global.er.decoupling.binding.response.GetParentTransactionResponseType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.vodafone.global.er.decoupling.binding.response.ParentTransactionType _ParentTransaction;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.GetParentTransactionResponseType.class);
    }

    public com.vodafone.global.er.decoupling.binding.response.ParentTransactionType getParentTransaction() {
        return _ParentTransaction;
    }

    public void setParentTransaction(com.vodafone.global.er.decoupling.binding.response.ParentTransactionType value) {
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.GetParentTransactionResponseTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        if (_ParentTransaction!= null) {
            context.startElement("", "parent-transaction");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ParentTransaction), "ParentTransaction");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ParentTransaction), "ParentTransaction");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _ParentTransaction), "ParentTransaction");
            context.endElement();
        }
    }
...
+"afone.global.er.decoupling.binding.response.ParentTransactio"
...
+"1/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0012parent-transactiont\u0000\u0000q\u0000~\u0000\u001c"
...
+"ool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000\u000fq\u0000~\u0000\"q\u0000~\u0000\u0012x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.GetParentTransactionResponseTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _ParentTransaction = ((com.vodafone.global.er.decoupling.binding.response.impl.ParentTransactionTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.ParentTransactionTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
