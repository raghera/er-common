...
public class CustcareFullRefundEnlargementTypeImpl implements com.vodafone.global.er.decoupling.binding.response.CustcareFullRefundEnlargementType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.vodafone.global.er.decoupling.binding.response.RefundAuthorisationFullType _RefundAuthorisation;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.CustcareFullRefundEnlargementType.class);
    }

    public com.vodafone.global.er.decoupling.binding.response.RefundAuthorisationFullType getRefundAuthorisation() {
        return _RefundAuthorisation;
    }

    public void setRefundAuthorisation(com.vodafone.global.er.decoupling.binding.response.RefundAuthorisationFullType value) {
        _RefundAuthorisation = value;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.CustcareFullRefundEnlargementTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (_RefundAuthorisation!= null) {
            context.startElement("", "refundAuthorisation");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _RefundAuthorisation), "RefundAuthorisation");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _RefundAuthorisation), "RefundAuthorisation");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _RefundAuthorisation), "RefundAuthorisation");
            context.endElement();
        }
    }
...
+"amet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000Ncom.vod"
+"afone.global.er.decoupling.binding.response.RefundAuthorisat"
+"ionFullTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000"
...
+"rg/2001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0013refundAuthorisationt"
...
+"essionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000\u000fq\u0000~\u0000\"q\u0000~\u0000\u0012x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.CustcareFullRefundEnlargementTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("is-success" == ___local)&&("" == ___uri)) {
                            _RefundAuthorisation = ((com.vodafone.global.er.decoupling.binding.response.impl.RefundAuthorisationFullTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.RefundAuthorisationFullTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
