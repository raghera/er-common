...
public class CatalogLittlePackagesImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.CatalogLittlePackages, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.CatalogLittlePackages.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "catalog-little-packages";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "catalog-little-packages");
...
+"spaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000Kcom.vodafone.global.er.decoupling.bind"
+"ing.response.CatalogPackageLittleTypet\u0000+http://java.sun.com/"
+"jaxb/xjc/dummy-elementssq\u0000~\u0000\nppsq\u0000~\u0000\u0016q\u0000~\u0000\u0010psr\u0000\u001bcom.sun.msv.g"
...
+"~\u0000 t\u0000\bpackagest\u0000\u0000q\u0000~\u0000\u001fsq\u0000~\u0000\nppsq\u0000~\u0000\u0016q\u0000~\u0000\u0010pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000"
+"~\u0000 t\u0000\u0017catalog-little-packagesq\u0000~\u0000?sr\u0000\"com.sun.msv.grammar.Ex"
...
+"\u0014q\u0000~\u0000%q\u0000~\u0000@q\u0000~\u0000\u000bq\u0000~\u0000\u000eq\u0000~\u0000\u0015x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("catalog-little-packages" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("packages" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
