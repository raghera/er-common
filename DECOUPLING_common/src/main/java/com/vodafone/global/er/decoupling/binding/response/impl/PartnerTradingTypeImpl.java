...
public class PartnerTradingTypeImpl implements com.vodafone.global.er.decoupling.binding.response.PartnerTradingType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected boolean has_PeriodDays;
    protected int _PeriodDays;
    protected boolean has_MaxCumulativeTransAmount;
    protected double _MaxCumulativeTransAmount;
    protected boolean has_MaxTransAmount;
    protected double _MaxTransAmount;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.PartnerTradingType.class);
    }
    ...
    public double getMaxCumulativeTransAmount() {
        return _MaxCumulativeTransAmount;
    }

    public void setMaxCumulativeTransAmount(double value) {
        _MaxCumulativeTransAmount = value;
        has_MaxCumulativeTransAmount = true;
    }
    ...
    public void setMaxTransAmount(double value) {
        _MaxTransAmount = value;
        has_MaxTransAmount = true;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.PartnerTradingTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (!has_PeriodDays) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "PeriodDays"));
        }
        if (!has_MaxCumulativeTransAmount) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "MaxCumulativeTransAmount"));
        }
        if (!has_MaxTransAmount) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "MaxTransAmount"));
        }
        ...
        context.endElement();
        context.startElement("", "max-trans-amount");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printDouble(((double) _MaxTransAmount)), "MaxTransAmount");
        } catch (java.lang.Exception e) {
            com.vodafone.global.er.decoupling.binding.response.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("", "max-cumulative-trans-amount");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printDouble(((double) _MaxCumulativeTransAmount)), "MaxCumulativeTransAmount");
        } catch (java.lang.Exception e) {
            com.vodafone.global.er.decoupling.binding.response.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("", "period-days");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _PeriodDays)), "PeriodDays");
        } catch (java.lang.Exception e) {
            com.vodafone.global.er.decoupling.binding.response.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"q\u0000~\u0000\u0011\u0001psq\u0000~\u0000.t\u0000\npartner-idt\u0000\u0000sq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\rppsr\u0000#co"
+"m.sun.msv.datatype.xsd.DoubleType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000+com.sun.msv."
+"datatype.xsd.FloatingNumberType\u00fc\u00e3\u00b6\u0087\u008c\u00a8|\u00e0\u0002\u0000\u0000xq\u0000~\u0000\u0014q\u0000~\u0000\u001at\u0000\u0006doub"
+"leq\u0000~\u0000,q\u0000~\u0000 sq\u0000~\u0000!q\u0000~\u0000?q\u0000~\u0000\u001asq\u0000~\u0000#ppsq\u0000~\u0000%q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00000q\u0000"
+"~\u00004sq\u0000~\u0000.t\u0000\u0010max-trans-amountq\u0000~\u00008sq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000;sq\u0000~\u0000"
+"#ppsq\u0000~\u0000%q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00000q\u0000~\u00004sq\u0000~\u0000.t\u0000\u001bmax-cumulative-trans-"
+"amountq\u0000~\u00008sq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\rppsr\u0000 com.sun.msv.datatype"
...
+"\u0000PL\u0000\fconcreteTypet\u0000\'Lcom/sun/msv/datatype/xsd/ConcreteType;L"
+"\u0000\tfacetNameq\u0000~\u0000\u0017xq\u0000~\u0000\u0016ppq\u0000~\u0000,\u0000\u0001sr\u0000*com.sun.msv.datatype.xsd."
+"MinInclusiveFacet\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000Tppq\u0000~\u0000,\u0000\u0000sr\u0000!com.sun.msv.d"
+"atatype.xsd.LongType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000Oq\u0000~\u0000\u001at\u0000\u0004longq\u0000~\u0000,sq\u0000~\u0000S"
+"ppq\u0000~\u0000,\u0000\u0001sq\u0000~\u0000Zppq\u0000~\u0000,\u0000\u0000sr\u0000$com.sun.msv.datatype.xsd.Integer"
+"Type\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000Oq\u0000~\u0000\u001at\u0000\u0007integerq\u0000~\u0000,sr\u0000,com.sun.msv.dat"
...
+"\u0000~\u0000bt\u0000\fminInclusivesr\u0000\u000ejava.lang.Long;\u008b\u00e4\u0090\u00cc\u008f#\u00df\u0002\u0000\u0001J\u0000\u0005valuexr\u0000\u0010"
+"java.lang.Number\u0086\u00ac\u0095\u001d\u000b\u0094\u00e0\u008b\u0002\u0000\u0000xp\u0080\u0000\u0000\u0000\u0000\u0000\u0000\u0000q\u0000~\u0000bt\u0000\fmaxInclusivesq\u0000"
+"~\u0000l\u007f\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ffq\u0000~\u0000]q\u0000~\u0000ksr\u0000\u0011java.lang.Integer\u0012\u00e2\u00a0\u00a4\u00f7\u0081\u00878\u0002\u0000\u0001I\u0000\u0005valu"
+"exq\u0000~\u0000m\u0080\u0000\u0000\u0000q\u0000~\u0000]q\u0000~\u0000osq\u0000~\u0000q\u007f\u00ff\u00ff\u00ffq\u0000~\u0000 sq\u0000~\u0000!q\u0000~\u0000Rq\u0000~\u0000\u001asq\u0000~\u0000#pp"
+"sq\u0000~\u0000%q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00000q\u0000~\u00004sq\u0000~\u0000.t\u0000\u000bperiod-daysq\u0000~\u00008sr\u0000\"com."
...
+"\u0000\u000b\u0001pq\u0000~\u0000\fq\u0000~\u0000\u0007q\u0000~\u0000Lq\u0000~\u0000$q\u0000~\u0000Aq\u0000~\u0000Gq\u0000~\u0000uq\u0000~\u0000\u0005q\u0000~\u0000:q\u0000~\u0000Fq\u0000~\u0000\u0006x"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.PartnerTradingTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        if (("max-trans-amount" == ___local)&&("" == ___uri)) {
                        ...
                        break;
                    case  9 :
                        if (("period-days" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 10;
                            return ;
                        }
                    ...
                    case  12 :
                        ...
                        return ;
                    case  6 :
                        if (("max-cumulative-trans-amount" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 7;
                            return ;
                        }
        ...
        {
            try {
                _MaxTransAmount = javax.xml.bind.DatatypeConverter.parseDouble(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_MaxTransAmount = true;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                _PeriodDays = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_PeriodDays = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        ...
        {
            try {
                _MaxCumulativeTransAmount = javax.xml.bind.DatatypeConverter.parseDouble(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_MaxCumulativeTransAmount = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
