...
public class ValidatePromoCodeResponseImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.ValidatePromoCodeResponseTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.ValidatePromoCodeResponse, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.ValidatePromoCodeResponse.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "validate-promo-code-response";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.ValidatePromoCodeResponseImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "validate-promo-code-response");
...
+"m.vodafone.global.er.decoupling.binding.response.ValidatePro"
+"moCodeResponseType.PackagesTypet\u0000+http://java.sun.com/jaxb/x"
...
+"packagest\u0000\u0000sq\u0000~\u0000\rppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00008q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u001cvalid"
+"ate-promo-code-responseq\u0000~\u0000=sr\u0000\"com.sun.msv.grammar.Expressi"
...
+"q\u0000~\u0000\tq\u0000~\u0000\u0011x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.ValidatePromoCodeResponseImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("packages" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.ValidatePromoCodeResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.ValidatePromoCodeResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  0 :
                        if (("validate-promo-code-response" == ___local)&&("" == ___uri)) {
