...
public class GetTaxResponseTypeImpl implements com.vodafone.global.er.decoupling.binding.response.GetTaxResponseType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.vodafone.global.er.decoupling.binding.response.TaxType _Tax;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.GetTaxResponseType.class);
    }

    public com.vodafone.global.er.decoupling.binding.response.TaxType getTax() {
        return _Tax;
    }

    public void setTax(com.vodafone.global.er.decoupling.binding.response.TaxType value) {
        _Tax = value;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.GetTaxResponseTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (_Tax!= null) {
            context.startElement("", "tax");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Tax), "Tax");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Tax), "Tax");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Tax), "Tax");
            context.endElement();
        }
    }
...
+"afone.global.er.decoupling.binding.response.TaxTypet\u0000+http:/"
...
+"stanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0003taxt\u0000\u0000q\u0000~\u0000\u001csr\u0000\"com.sun.msv.grammar.Expre"
...
+"~\u0000\"q\u0000~\u0000\u0012x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.GetTaxResponseTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _Tax = ((com.vodafone.global.er.decoupling.binding.response.impl.TaxTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.TaxTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
