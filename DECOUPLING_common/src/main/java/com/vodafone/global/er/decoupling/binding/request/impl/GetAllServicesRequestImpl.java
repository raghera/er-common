...
public class GetAllServicesRequestImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.GetAllServicesRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.GetAllServicesRequest.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "get-all-services-request";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.GetAllServicesRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "get-all-services-request");
...
+"\u0000!sq\u0000~\u00007t\u0000\u0018get-all-services-requestt\u0000\u0000sr\u0000\"com.sun.msv.gramma"
...
+"q\u0000~\u0000\fq\u0000~\u0000\u0010q\u0000~\u0000\"x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.GetAllServicesRequestImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("get-all-services-request" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetAllServicesRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetAllServicesRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetAllServicesRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetAllServicesRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetAllServicesRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetAllServicesRequestImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
