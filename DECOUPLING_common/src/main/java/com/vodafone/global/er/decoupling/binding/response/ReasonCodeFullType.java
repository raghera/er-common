...
/**
 * <p>Java class for reasonCodeFullType complex type.
 * 
...
@XmlType(name = "reasonCodeFullType", namespace = "http://localhost:8080/decoupling/schemas/common", propOrder = {
    "code",
    "subCode",
    "name"
})
public class ReasonCodeFullType
