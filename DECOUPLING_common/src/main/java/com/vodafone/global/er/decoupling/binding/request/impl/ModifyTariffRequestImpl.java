...
public class ModifyTariffRequestImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.ModifyTariffRequestTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.ModifyTariffRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.ModifyTariffRequest.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.ModifyTariffRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "modify-tariff-request");
...
+"~\u00009sq\u0000~\u00003t\u0000\u0006actionq\u0000~\u0000=sq\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0017p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0015sq\u0000"
+"~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\fsourceTariffq\u0000~\u0000=q\u0000"
+"~\u00009sq\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0017p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~"
+"\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0011destinationTariffq\u0000~\u0000=q\u0000~\u00009sq\u0000~\u0000(ppsq\u0000~"
+"\u0000\u0000q\u0000~\u0000\u0017p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000"
+"~\u00003t\u0000\tclient-idq\u0000~\u0000=q\u0000~\u00009sq\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0017p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0015s"
+"q\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0006reasonq\u0000~\u0000=q\u0000~\u00009s"
+"q\u0000~\u0000(ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0017p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000"
+"~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0006log-idq\u0000~\u0000=q\u0000~\u00009sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000"
+"~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0015modify-tariff-requestq\u0000~\u0000=sr\u0000\"com.sun.msv.g"
...
+"q\u0000~\u0000Dq\u0000~\u0000Kq\u0000~\u0000Rq\u0000~\u0000Yq\u0000~\u0000`q\u0000~\u0000\u0011q\u0000~\u0000?q\u0000~\u0000Fq\u0000~\u0000Mq\u0000~\u0000Tq\u0000~\u0000[q\u0000~\u0000b"
+"q\u0000~\u0000\tq\u0000~\u0000\u000eq\u0000~\u0000)q\u0000~\u0000@q\u0000~\u0000Gq\u0000~\u0000Nq\u0000~\u0000Uq\u0000~\u0000\\q\u0000~\u0000cq\u0000~\u0000gq\u0000~\u0000\u000bq\u0000~\u0000\u000f"
+"q\u0000~\u0000\nq\u0000~\u0000\rx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.ModifyTariffRequestImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("modify-tariff-request" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("msisdn" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.ModifyTariffRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.ModifyTariffRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
