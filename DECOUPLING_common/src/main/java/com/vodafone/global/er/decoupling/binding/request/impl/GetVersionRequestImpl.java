...
public class GetVersionRequestImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.GetVersionRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.GetVersionRequest.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.GetVersionRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "get-version-request");
...
+"\u0000!sq\u0000~\u00007t\u0000\u0013get-version-requestt\u0000\u0000sr\u0000\"com.sun.msv.grammar.Exp"
...
+"q\u0000~\u0000\u0010q\u0000~\u0000\"x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.GetVersionRequestImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetVersionRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetVersionRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
                        if (("get-version-request" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetVersionRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("get-version-request" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetVersionRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetVersionRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.request.impl.AnyTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.GetVersionRequestImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
