...
public class SelfcareMicroServicesImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.SelfcareMicroServices, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.SelfcareMicroServices.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "selfcare-micro-services";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "selfcare-micro-services");
...
+"ing.response.MicroServiceTypet\u0000+http://java.sun.com/jaxb/xjc"
...
+"t\u0000)http://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\rmi"
+"cro-servicet\u0000\u0000q\u0000~\u0000\u001fsq\u0000~\u0000\nppsq\u0000~\u0000\u0016q\u0000~\u0000\u0010pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 "
+"t\u0000\u0017selfcare-micro-servicesq\u0000~\u0000?sr\u0000\"com.sun.msv.grammar.Expre"
...
+"~\u0000%q\u0000~\u0000@q\u0000~\u0000\u000bq\u0000~\u0000\u000eq\u0000~\u0000\u0015x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (("micro-service" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("selfcare-micro-services" == ___local)&&("" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
