...
public class CatalogLittlePackagesTypeImpl implements com.vodafone.global.er.decoupling.binding.response.CatalogLittlePackagesType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Packages;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.CatalogLittlePackagesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getPackages() {
        if (_Packages == null) {
            _Packages = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Packages;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Packages == null)? 0 :_Packages.size());
        while (idx1 != len1) {
            context.startElement("", "packages");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Packages.get(idx_0 ++)), "Packages");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Packages.get(idx_1 ++)), "Packages");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Packages.get(idx1 ++)), "Packages");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000Kcom.vodafone.global.er.decoupling.binding.response.Cata"
+"logPackageLittleTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-el"
...
+"sionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.CatalogLittlePackagesTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _getPackages().add(((com.vodafone.global.er.decoupling.binding.response.impl.CatalogPackageLittleTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.CatalogPackageLittleTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
