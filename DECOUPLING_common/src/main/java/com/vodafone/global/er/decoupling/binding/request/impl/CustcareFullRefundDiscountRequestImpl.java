...
public class CustcareFullRefundDiscountRequestImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.CustcareFullRefundDiscountRequestTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.CustcareFullRefundDiscountRequest, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.CustcareFullRefundDiscountRequest.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "custcare-full-refund-discount-request";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.CustcareFullRefundDiscountRequestImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "custcare-full-refund-discount-request");
...
+"loatingNumberType\u00fc\u00e3\u00b6\u0087\u008c\u00a8|\u00e0\u0002\u0000\u0000xq\u0000~\u0000\u0017q\u0000~\u0000\u001dt\u0000\u0006doubleq\u0000~\u0000/q\u0000~\u0000#sq"
+"\u0000~\u0000$q\u0000~\u0000Hq\u0000~\u0000\u001dsq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\bdi"
+"scountq\u0000~\u0000;sq\u0000~\u0000&ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000&ppsr\u0000"
...
+"\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00002q\u0000~\u00007sq\u0000~\u00001t\u0000Fcom.vodafone.global.er.decoupling."
+"binding.request.RefundAttributesTypet\u0000+http://java.sun.com/j"
+"axb/xjc/dummy-elementssq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000"
+"~\u00001t\u0000\u0011refund-attributesq\u0000~\u0000;q\u0000~\u00007sq\u0000~\u0000&ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0007"
+"ppq\u0000~\u0000\u0013sq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0006log-idq\u0000~"
+"\u0000;q\u0000~\u00007sq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000%custcare-"
+"full-refund-discount-requestq\u0000~\u0000;sr\u0000\"com.sun.msv.grammar.Exp"
...
+"$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0014\u0001pq\u0000~\u0000\u000bq\u0000~\u0000Nq\u0000~\u0000b"
+"q\u0000~\u0000\u000fq\u0000~\u0000=q\u0000~\u0000Uq\u0000~\u0000dq\u0000~\u0000Pq\u0000~\u0000\nq\u0000~\u0000Rq\u0000~\u0000\tq\u0000~\u0000\'q\u0000~\u0000>q\u0000~\u0000Jq\u0000~\u0000^"
+"q\u0000~\u0000eq\u0000~\u0000iq\u0000~\u0000Cq\u0000~\u0000\rq\u0000~\u0000\fx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.CustcareFullRefundDiscountRequestImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("msisdn" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.CustcareFullRefundDiscountRequestTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.CustcareFullRefundDiscountRequestImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  0 :
                        if (("custcare-full-refund-discount-request" == ___local)&&("" == ___uri)) {
