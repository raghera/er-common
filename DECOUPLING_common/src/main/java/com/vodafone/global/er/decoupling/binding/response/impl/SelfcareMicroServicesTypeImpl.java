...
public class SelfcareMicroServicesTypeImpl implements com.vodafone.global.er.decoupling.binding.response.SelfcareMicroServicesType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _MicroService;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.SelfcareMicroServicesType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getMicroService() {
        if (_MicroService == null) {
            _MicroService = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _MicroService;
    }

    public java.util.List getMicroService() {
        return _getMicroService();
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_MicroService == null)? 0 :_MicroService.size());
        while (idx1 != len1) {
            context.startElement("", "micro-service");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _MicroService.get(idx_0 ++)), "MicroService");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _MicroService.get(idx_1 ++)), "MicroService");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _MicroService.get(idx1 ++)), "MicroService");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000Ccom.vodafone.global.er.decoupling.binding.response.Micr"
+"oServiceTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq"
...
+"org/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\rmicro-servicet\u0000\u0000q\u0000~"
...
+"nPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.SelfcareMicroServicesTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _getMicroService().add(((com.vodafone.global.er.decoupling.binding.response.impl.MicroServiceTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.MicroServiceTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
