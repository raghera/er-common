...
public class IsUniquePromoPrecodeResponseImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.IsUniquePromoPrecodeResponseTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.IsUniquePromoPrecodeResponse, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.IsUniquePromoPrecodeResponse.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "is-unique-promo-precode-response";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.IsUniquePromoPrecodeResponseImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "is-unique-promo-precode-response");
...
+"ression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\u001e\u0001psq\u0000~\u0000+t\u0000\u0017is-unique-promo-pre"
+"codet\u0000\u0000sq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\u001fpq\u0000~\u0000&q\u0000~\u0000-q\u0000~\u00001sq\u0000~\u0000+t\u0000 is-unique"
+"-promo-precode-responseq\u0000~\u00005sr\u0000\"com.sun.msv.grammar.Expressi"
...
+"/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000#q\u0000~\u00006q\u0000~\u0000\tq\u0000~\u0000\u000b"
+"x"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.IsUniquePromoPrecodeResponseImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("is-unique-promo-precode-response" == ___local)&&("" == ___uri)) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        if (("is-unique-promo-precode" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.IsUniquePromoPrecodeResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.IsUniquePromoPrecodeResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
