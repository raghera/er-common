...
public class NotificationSubscribeResponseImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.NotificationSubscribeResponseTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.NotificationSubscribeResponse, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.NotificationSubscribeResponse.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "notification-subscribe-response";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.NotificationSubscribeResponseImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "notification-subscribe-response");
...
+"q\u0000~\u0000$q\u0000~\u0000\u001fpq\u0000~\u0000&q\u0000~\u0000-q\u0000~\u00001sq\u0000~\u0000+t\u0000\u001fnotification-subscribe-re"
+"sponseq\u0000~\u00005sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001"
...
+"ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000#q\u0000~\u00006q\u0000~\u0000\tq\u0000~\u0000\u000bx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.NotificationSubscribeResponseImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("notification-subscribe-response" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("success" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.NotificationSubscribeResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.NotificationSubscribeResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
