 ...
 *         &lt;element name="billingcycle" type="{http://localhost:8080/decoupling/schemas/common}billingcycle"/>
...
@XmlRootElement(name = "modify-billingcycle", namespace = "")
public class ModifyBillingcycle
