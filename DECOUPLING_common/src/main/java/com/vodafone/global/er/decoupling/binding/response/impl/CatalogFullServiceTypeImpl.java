...
public class CatalogFullServiceTypeImpl implements com.vodafone.global.er.decoupling.binding.response.CatalogFullServiceType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.vodafone.global.er.decoupling.binding.response.ErServiceFullType _Service;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.CatalogFullServiceType.class);
    }

    public com.vodafone.global.er.decoupling.binding.response.ErServiceFullType getService() {
        return _Service;
    }

    public void setService(com.vodafone.global.er.decoupling.binding.response.ErServiceFullType value) {
        _Service = value;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.CatalogFullServiceTypeImpl.Unmarshaller(context);
    }
...
+"amet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000Dcom.vod"
+"afone.global.er.decoupling.binding.response.ErServiceFullTyp"
...
+"LSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0007servicet\u0000\u0000q\u0000~\u0000\u001csr\u0000\"com.sun.msv"
...
+"\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000\u000fq\u0000~\u0000\"q\u0000~\u0000\u0012x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.CatalogFullServiceTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _Service = ((com.vodafone.global.er.decoupling.binding.response.impl.ErServiceFullTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.ErServiceFullTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
