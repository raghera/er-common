...
public class ModifyBanResponseImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.ModifyBanResponseTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.ModifyBanResponse, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.ModifyBanResponse.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.ModifyBanResponseImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "modify-ban-response");
...
+"q\u0000~\u0000$q\u0000~\u0000\u001fpq\u0000~\u0000&q\u0000~\u0000-q\u0000~\u00001sq\u0000~\u0000+t\u0000\u0013modify-ban-responseq\u0000~\u00005s"
...
+"ol;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000#q\u0000~\u00006q\u0000~\u0000\tq\u0000~\u0000\u000bx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.ModifyBanResponseImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("success" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.ModifyBanResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.ModifyBanResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  0 :
                        if (("modify-ban-response" == ___local)&&("" == ___uri)) {
