...
public class SelfcareLiteTransactionsImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.SelfcareLiteTransactions, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.SelfcareLiteTransactions.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "selfcare-lite-transactions";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "selfcare-lite-transactions");
...
+"ing.response.TransactionLiteTypet\u0000+http://java.sun.com/jaxb/"
...
+"\u0010lite-transactiont\u0000\u0000q\u0000~\u0000\u001fsq\u0000~\u0000\nppsq\u0000~\u0000\u0016q\u0000~\u0000\u0010pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001f"
+"sq\u0000~\u0000 t\u0000\u001aselfcare-lite-transactionsq\u0000~\u0000?sr\u0000\"com.sun.msv.gram"
...
+"\u0000\tq\u0000~\u0000\u0014q\u0000~\u0000%q\u0000~\u0000@q\u0000~\u0000\u000bq\u0000~\u0000\u000eq\u0000~\u0000\u0015x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        if (("lite-transaction" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
                        if (("selfcare-lite-transactions" == ___local)&&("" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("selfcare-lite-transactions" == ___local)&&("" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.SelfcareLiteTransactionsImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
