...
public class SelfcareFullTransactionTypeImpl implements com.vodafone.global.er.decoupling.binding.response.SelfcareFullTransactionType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.vodafone.global.er.decoupling.binding.response.TransactionFullType _Transaction;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.SelfcareFullTransactionType.class);
    }

    public com.vodafone.global.er.decoupling.binding.response.TransactionFullType getTransaction() {
        return _Transaction;
    }

    public void setTransaction(com.vodafone.global.er.decoupling.binding.response.TransactionFullType value) {
        _Transaction = value;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.SelfcareFullTransactionTypeImpl.Unmarshaller(context);
    }
...
+"amet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000Fcom.vod"
+"afone.global.er.decoupling.binding.response.TransactionFullT"
...
+"XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u000btransactiont\u0000\u0000q\u0000~\u0000\u001csr\u0000\"com.s"
...
+"\u0005\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000\u000fq\u0000~\u0000\"q\u0000~\u0000\u0012x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.SelfcareFullTransactionTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("id" == ___local)&&("" == ___uri)) {
                            _Transaction = ((com.vodafone.global.er.decoupling.binding.response.impl.TransactionFullTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.TransactionFullTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
