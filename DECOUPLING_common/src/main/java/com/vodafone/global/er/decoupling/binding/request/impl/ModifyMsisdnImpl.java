...
public class ModifyMsisdnImpl
    extends com.vodafone.global.er.decoupling.binding.request.impl.ModifyMsisdnTypeImpl
    implements com.vodafone.global.er.decoupling.binding.request.ModifyMsisdn, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.ModifyMsisdn.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.ModifyMsisdnImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "modify-msisdn");
...
+"q\u0000~\u0000\u0007ppq\u0000~\u0000\u0013sq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\nnew-"
+"msisdnq\u0000~\u0000;sq\u0000~\u0000&ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0013sq\u0000~\u0000&ppsq\u0000~\u0000(q"
+"\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0006csr-idq\u0000~\u0000;q\u0000~\u00007sq\u0000~\u0000&ppsq\u0000~\u0000\u0000q"
+"\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0013sq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001"
+"t\u0000\u0006reasonq\u0000~\u0000;q\u0000~\u00007sq\u0000~\u0000&ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0013sq\u0000~\u0000&p"
+"psq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0006log-idq\u0000~\u0000;q\u0000~\u00007sq\u0000~\u0000&p"
+"psq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\rmodify-msisdnq\u0000~\u0000;sr\u0000\"c"
...
+"p\u0000\u0000\u0000\u0013\u0001pq\u0000~\u0000\nq\u0000~\u0000\tq\u0000~\u0000Bq\u0000~\u0000Iq\u0000~\u0000Pq\u0000~\u0000\u000fq\u0000~\u0000=q\u0000~\u0000Dq\u0000~\u0000Kq\u0000~\u0000Rq\u0000~"
+"\u0000\fq\u0000~\u0000\'q\u0000~\u0000>q\u0000~\u0000Eq\u0000~\u0000Lq\u0000~\u0000Sq\u0000~\u0000Wq\u0000~\u0000\rq\u0000~\u0000\u000bx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.ModifyMsisdnImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("modify-msisdn" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("msisdn" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.request.impl.ModifyMsisdnTypeImpl)com.vodafone.global.er.decoupling.binding.request.impl.ModifyMsisdnImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
