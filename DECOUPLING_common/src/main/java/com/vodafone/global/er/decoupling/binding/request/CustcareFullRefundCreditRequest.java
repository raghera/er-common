 ...
 *         &lt;element name="refund-attributes" type="{http://localhost:8080/decoupling/schemas/common}refundAttributesType"/>
...
@XmlRootElement(name = "custcare-full-refund-credit-request", namespace = "")
public class CustcareFullRefundCreditRequest
    implements Serializable, Element
{
    ...
    @XmlElement(name = "refund-attributes", required = true)
