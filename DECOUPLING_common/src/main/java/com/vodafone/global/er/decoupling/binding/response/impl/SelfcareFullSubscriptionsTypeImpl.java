...
public class SelfcareFullSubscriptionsTypeImpl implements com.vodafone.global.er.decoupling.binding.response.SelfcareFullSubscriptionsType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Subscription;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.SelfcareFullSubscriptionsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getSubscription() {
        if (_Subscription == null) {
            _Subscription = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.SelfcareFullSubscriptionsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Subscription == null)? 0 :_Subscription.size());
        while (idx1 != len1) {
            context.startElement("", "subscription");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Subscription.get(idx_0 ++)), "Subscription");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Subscription.get(idx_1 ++)), "Subscription");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Subscription.get(idx1 ++)), "Subscription");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000Gcom.vodafone.global.er.decoupling.binding.response.Subs"
+"criptionFullTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elemen"
...
+".w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\fsubscriptiont\u0000\u0000"
...
+"sionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.SelfcareFullSubscriptionsTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("package" == ___local)&&("" == ___uri)) {
                            _getSubscription().add(((com.vodafone.global.er.decoupling.binding.response.impl.SubscriptionFullTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.SubscriptionFullTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
