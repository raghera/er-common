...
public class ModifyUsergroupTypeImpl implements com.vodafone.global.er.decoupling.binding.request.ModifyUsergroupType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.request.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.request.impl.runtime.ValidatableObject
{

    protected java.lang.String _Action;
    protected java.lang.String _CsrId;
    protected com.vodafone.global.er.decoupling.binding.request.Usergroups _Usergroups;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.request.ModifyUsergroupType.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.Usergroups getUsergroups() {
        return _Usergroups;
    }

    public void setUsergroups(com.vodafone.global.er.decoupling.binding.request.Usergroups value) {
        _Usergroups = value;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.request.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.request.impl.ModifyUsergroupTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endElement();
        context.startElement("", "usergroups");
...
+"ringExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u00007psr\u0000 com.sun.msv.grammar"
+".AnyNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00001q\u0000~\u00006sq\u0000~\u00000t\u0000<com.vodafone.glo"
+"bal.er.decoupling.binding.request.Usergroupst\u0000+http://java.s"
+"un.com/jaxb/xjc/dummy-elementssq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00002"
+"q\u0000~\u00006sq\u0000~\u00000t\u0000\nusergroupsq\u0000~\u0000:sq\u0000~\u0000%ppsq\u0000~\u0000\nq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0000ppq\u0000"
+"~\u0000\u0012sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u0006csr-idq\u0000~\u0000:q\u0000"
+"~\u00006sq\u0000~\u0000%ppsq\u0000~\u0000\nq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0012sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~"
+"\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u0006reasonq\u0000~\u0000:q\u0000~\u00006sq\u0000~\u0000%ppsq\u0000~\u0000\nq\u0000~\u0000\u0014p\u0000sq"
+"\u0000~\u0000\u0000ppq\u0000~\u0000\u0012sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u0006log-i"
+"dq\u0000~\u0000:q\u0000~\u00006sq\u0000~\u0000%ppsq\u0000~\u0000\nq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0012sq\u0000~\u0000%ppsq\u0000~\u0000\'q"
+"\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u0006actionq\u0000~\u0000:q\u0000~\u00006sr\u0000\"com.sun.msv"
...
+"\u0000Nq\u0000~\u0000Uq\u0000~\u0000\\q\u0000~\u0000cq\u0000~\u0000\u000eq\u0000~\u0000Aq\u0000~\u0000Pq\u0000~\u0000Wq\u0000~\u0000^q\u0000~\u0000eq\u0000~\u0000<q\u0000~\u0000\u0005q\u0000~"
+"\u0000>q\u0000~\u0000&q\u0000~\u0000Jq\u0000~\u0000Qq\u0000~\u0000Xq\u0000~\u0000\u0007q\u0000~\u0000_q\u0000~\u0000fq\u0000~\u0000\u0006q\u0000~\u0000\bq\u0000~\u0000\tx"));
        }
        ...
        extends com.vodafone.global.er.decoupling.binding.request.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.request.impl.ModifyUsergroupTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("usergroup" == ___local)&&("" == ___uri)) {
                            _Usergroups = ((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _Usergroups = ((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl.class), 5, ___uri, ___local, ___qname, __atts));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  6 :
                        ...
                        continue outer;
                    case  4 :
                        _Usergroups = ((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl) spawnChildFromLeaveElement((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                    case  15 :
                        state = 18;
                        continue outer;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  6 :
                        ...
                        continue outer;
                    case  4 :
                        _Usergroups = ((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl) spawnChildFromEnterAttribute((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                    case  15 :
                        state = 18;
                        continue outer;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  6 :
                        ...
                        continue outer;
                    case  4 :
                        _Usergroups = ((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl) spawnChildFromLeaveAttribute((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                    case  15 :
                        state = 18;
                        continue outer;
                ...
                try {
                    switch (state) {
                        ...
                        case  6 :
                            ...
                            continue outer;
                        case  4 :
                            _Usergroups = ((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl) spawnChildFromText((com.vodafone.global.er.decoupling.binding.request.impl.UsergroupsImpl.class), 5, value));
                            return ;
                        case  15 :
                            state = 18;
                            continue outer;
