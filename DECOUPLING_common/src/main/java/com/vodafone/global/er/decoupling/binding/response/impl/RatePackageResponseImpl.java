...
public class RatePackageResponseImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.RatePackageResponse, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.RatePackageResponse.class);
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "rate-package-response");
...
+" xq\u0000~\u0000\u001bt\u0000>com.vodafone.global.er.decoupling.binding.response"
+".PackageTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq"
...
+"org/2001/XMLSchema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0007packaget\u0000\u0000q\u0000~\u0000\u001esq\u0000~"
+"\u0000\nppsq\u0000~\u0000\u0015q\u0000~\u0000\u000epq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0015rate-package-respons"
...
+"ssionPool;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000\u000bq\u0000~\u0000\u000fq\u0000~\u0000\tq\u0000~\u0000\u0011q\u0000~\u0000$q\u0000~\u0000?q\u0000~\u0000\u0014x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("rate-package-response" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("package" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.RatePackageResponseImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
