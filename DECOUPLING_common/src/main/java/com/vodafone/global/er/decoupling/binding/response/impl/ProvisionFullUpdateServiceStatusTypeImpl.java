...
public class ProvisionFullUpdateServiceStatusTypeImpl implements com.vodafone.global.er.decoupling.binding.response.ProvisionFullUpdateServiceStatusType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected com.vodafone.global.er.decoupling.binding.response.UpdateServiceStatusAuthorisationFullType _UpdateServiceStatusAuthorisation;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.ProvisionFullUpdateServiceStatusType.class);
    }

    public com.vodafone.global.er.decoupling.binding.response.UpdateServiceStatusAuthorisationFullType getUpdateServiceStatusAuthorisation() {
        return _UpdateServiceStatusAuthorisation;
    }

    public void setUpdateServiceStatusAuthorisation(com.vodafone.global.er.decoupling.binding.response.UpdateServiceStatusAuthorisationFullType value) {
        _UpdateServiceStatusAuthorisation = value;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.ProvisionFullUpdateServiceStatusTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "update-service-status-authorisation");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _UpdateServiceStatusAuthorisation), "UpdateServiceStatusAuthorisation");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _UpdateServiceStatusAuthorisation), "UpdateServiceStatusAuthorisation");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _UpdateServiceStatusAuthorisation), "UpdateServiceStatusAuthorisation");
        context.endElement();
    }
...
+".er.decoupling.binding.response.UpdateServiceStatusAuthorisa"
+"tionFullTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq"
...
+"org/2001/XMLSchema-instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000#update-service-stat"
+"us-authorisationt\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000"
...
+"grammar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000!q\u0000~\u0000\u000fx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.ProvisionFullUpdateServiceStatusTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("reason-code" == ___local)&&("" == ___uri)) {
                            _UpdateServiceStatusAuthorisation = ((com.vodafone.global.er.decoupling.binding.response.impl.UpdateServiceStatusAuthorisationFullTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.UpdateServiceStatusAuthorisationFullTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
                        if (("update-service-status-authorisation" == ___local)&&("" == ___uri)) {
