...
public class BalanceFilterImpl implements com.vodafone.global.er.decoupling.binding.response.BalanceFilter, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{

    protected boolean has_OnlyAceAttribute;
    protected boolean _OnlyAceAttribute;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.BalanceFilter.class);
    }

    public boolean isOnlyAceAttribute() {
        return _OnlyAceAttribute;
    }

    public void setOnlyAceAttribute(boolean value) {
        _OnlyAceAttribute = value;
        has_OnlyAceAttribute = true;
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.BalanceFilterImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (!has_OnlyAceAttribute) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "OnlyAceAttribute"));
        }
        context.startElement("", "only-ace-attribute");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _OnlyAceAttribute)), "OnlyAceAttribute");
...
+"\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\u001c\u0001psq\u0000~\u0000)t\u0000\u0012only-ace-attributet\u0000\u0000sr\u0000\"com.sun.msv"
...
+"\u0000!q\u0000~\u0000\tx"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.BalanceFilterImpl.this;
        }
        ...
        {
            try {
                _OnlyAceAttribute = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_OnlyAceAttribute = true;
            } catch (java.lang.Exception e) {
