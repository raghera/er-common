...
public class PartnerTradingLimitsTypeImpl implements com.vodafone.global.er.decoupling.binding.response.PartnerTradingLimitsType, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.PartnerTradingLimitsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getPartnerTradingLimit() {
        if (_PartnerTradingLimit == null) {
            _PartnerTradingLimit = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _PartnerTradingLimit;
    }

    public java.util.List getPartnerTradingLimit() {
        return _getPartnerTradingLimit();
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.PartnerTradingLimitsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_PartnerTradingLimit == null)? 0 :_PartnerTradingLimit.size());
        while (idx1 != len1) {
            context.startElement("", "partner-trading-limit");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _PartnerTradingLimit.get(idx_0 ++)), "PartnerTradingLimit");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _PartnerTradingLimit.get(idx_1 ++)), "PartnerTradingLimit");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _PartnerTradingLimit.get(idx1 ++)), "PartnerTradingLimit");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000Ecom.vodafone.global.er.decoupling.binding.response.Part"
+"nerTradingTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elements"
...
+"3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0015partner-trading-l"
+"imitt\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
...
+"/ExpressionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0010q\u0000~\u0000\u0012q\u0000~\u0000#q\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.PartnerTradingLimitsTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("partner-id" == ___local)&&("" == ___uri)) {
                            _getPartnerTradingLimit().add(((com.vodafone.global.er.decoupling.binding.response.impl.PartnerTradingTypeImpl) spawnChildFromEnterElement((com.vodafone.global.er.decoupling.binding.response.impl.PartnerTradingTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                }
