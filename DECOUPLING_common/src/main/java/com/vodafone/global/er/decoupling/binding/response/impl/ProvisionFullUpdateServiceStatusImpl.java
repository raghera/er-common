...
public class ProvisionFullUpdateServiceStatusImpl
    extends com.vodafone.global.er.decoupling.binding.response.impl.ProvisionFullUpdateServiceStatusTypeImpl
    implements com.vodafone.global.er.decoupling.binding.response.ProvisionFullUpdateServiceStatus, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallableObject, com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializable, com.vodafone.global.er.decoupling.binding.response.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.vodafone.global.er.decoupling.binding.response.ProvisionFullUpdateServiceStatus.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "provision-full-update-service-status";
    }
    ...
    public com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.vodafone.global.er.decoupling.binding.response.impl.runtime.UnmarshallingContext context) {
        return new com.vodafone.global.er.decoupling.binding.response.impl.ProvisionFullUpdateServiceStatusImpl.Unmarshaller(context);
    }

    public void serializeBody(com.vodafone.global.er.decoupling.binding.response.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "provision-full-update-service-status");
...
+"m.vodafone.global.er.decoupling.binding.response.UpdateServi"
+"ceStatusAuthorisationFullTypet\u0000+http://java.sun.com/jaxb/xjc"
+"/dummy-elementssq\u0000~\u0000\rppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013psr\u0000\u001bcom.sun.msv.grammar.D"
...
+"t\u0000)http://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000#up"
+"date-service-status-authorisationt\u0000\u0000sq\u0000~\u0000\rppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u0000"
+"(q\u0000~\u00008q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000$provision-full-update-service-statusq\u0000~\u0000"
...
+"Pool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u000bq\u0000~\u0000\u000eq\u0000~\u0000#q\u0000~\u0000>q\u0000~\u0000\tq\u0000~\u0000\u0011x"));
        ...
        extends com.vodafone.global.er.decoupling.binding.response.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.vodafone.global.er.decoupling.binding.response.impl.ProvisionFullUpdateServiceStatusImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("provision-full-update-service-status" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("update-service-status-authorisation" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.vodafone.global.er.decoupling.binding.response.impl.ProvisionFullUpdateServiceStatusTypeImpl)com.vodafone.global.er.decoupling.binding.response.impl.ProvisionFullUpdateServiceStatusImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
