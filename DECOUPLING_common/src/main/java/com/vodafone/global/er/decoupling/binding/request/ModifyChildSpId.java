 ...
 *         &lt;element name="child-sp-id" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "modify-child-sp-id", namespace = "")
public class ModifyChildSpId
    implements Serializable, Element
{
    ...
    @XmlElement(name = "child-sp-id", required = true)
