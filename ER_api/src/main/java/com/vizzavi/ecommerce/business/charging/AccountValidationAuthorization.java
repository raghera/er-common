 ...
 */
public class AccountValidationAuthorization implements java.io.Serializable
{
...
//				mUserGroups.add(new String(userGroup));
//			}
//	  	}
...
//	  	if (userGroups != null)
//	  		mUserGroups = Arrays.asList(userGroups);
//	  	else
//	  		mUserGroups = new ArrayList<String>();

        if (userGroups != null) {
            mUserGroups = new HashSet<>(Arrays.asList(userGroups));
        }
        else {
    ...
    /**
     * Set the user groups for an authorization result
     * @param userGrps the list of user groups
     */
...
//    }
    ...
    public boolean isChargeable() {
        ...
        if (mStatus != null && !mStatus.equals("")) {
            rv = ResponseStatus.isAccepted(mStatus);
        }
