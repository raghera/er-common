 ...
 * CR1978 - Global-ER
 * 
 * Implementation class of FileAppender that would append locale information
 * (i.e. LOCALE:&lt;COUNTRY CODE&gt;) to the log message.
 * 
 */
public class LocaleFileAppender extends FileAppender {
