...
public interface HttpHeaderAware {
	...
	/**
	 * set a list of key value pairs which will be added as http headers on the next request only.  Each time you call this method, it replaces the previously added headers.
	...
	/**
	 * set the list of headers which will be added on the next request only.  May over-write any headers set previously.
	 * @param headers
